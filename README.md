...
Analitico: Comprendere quali fattori influenzano maggiormente le visualizzazioni e i like. La durata conta? La definizione HD è determinante?

Strategico: Fornire strumenti (cluster e modelli predittivi) per stimare se un video avrà un alto tasso di coinvolgimento (High Engagement) basandosi sulle sue caratteristiche tecniche.
...
Creazione della Variabile Target: Definizione di "Video di Successo" basata sul superamento della mediana dell'engagement_rate.
